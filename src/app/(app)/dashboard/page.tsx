    ...
    <div className="p-6 max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <section className="space-y-2">
        ...
        <ProgressVessel 
          ...
          myDepositsCount={myDeposits.length}
          partnerDepositsCount={partnerDeposits.length}
          myAmount={myAmount}
        ...
        <Card className="shadow-sm">
          <CardContent className="p-4 space-y-3">
            ...
            <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
              <div className="h-full bg-foreground transition-all duration-1000" style={{ width: `${myPercentual}%` }} />
            </div>
          </CardContent>
        </Card>
