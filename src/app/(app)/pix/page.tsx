    ...
    <div className="p-6 sm:p-8 max-w-2xl mx-auto space-y-10">
      <header className="space-y-1 border-b border-border pb-6">
        <div className="flex items-center gap-2 text-primary mb-2">
          ...
          <span className="font-medium text-xs tracking-widest uppercase">Pagamentos</span>
        </div>
      ...
      <section className="space-y-6">
        ...
        {partnerProfile?.pix_key && (
           <div className="p-5 border border-border rounded-2xl bg-card space-y-3">
             ...
             <div className="flex items-center gap-3 bg-background p-4 rounded-xl border border-border">
               ...
               <code className="text-lg font-semibold text-foreground tracking-tight break-all">
                 {partnerProfile.pix_key}
               </code>
             </div>
